...
const ProjectCard: React.FC<ProjectCardProps> = ({ 
  ...
  return (
    <div className="bg-slate-900 border-[1px] border-slate-800 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl hover:bg-[#181a44] transform hover:-translate-y-2 transition-all duration-300 cursor-pointer">
      {image && (
          ...
          <div className="flex gap-3 mt-4">
            {liveUrl && (
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="bg-[#d038d2] hover:bg-[#ff32f5] text-white px-4 py-2 rounded-lg font-medium transition-colors duration-300 flex items-center gap-2"
              >
